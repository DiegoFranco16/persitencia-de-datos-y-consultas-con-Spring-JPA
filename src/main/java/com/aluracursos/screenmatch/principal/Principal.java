...
public class Principal {
    ...
    public void muestraElMenu() {
        ...
        while (opcion != 0) {
            var menu = """
                    ...
                    7 - Filtrar series por su número de temporadas y evaluación
    ...
    private void buscarEpisodioPorSerie() {
        //DatosSerie datosSerie = getDatosSerie(); esta línea busca desde la API
        mostrarSeriesBuscadas();        //Esta línea busca los episodios de las series guardadas en la BD
...
//                .collect(Collectors.toList());
    ...
    private void buscarSeriesPorCategoria(){
        System.out.println("Escriba el género/categoría de la serie a buscar");
